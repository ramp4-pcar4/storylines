import{t as e}from"./ShaderBuilder-aUMFb5cS-Bh1P788U.js";import{t}from"./glsl-EDZkDhgF-n7nRq5tN.js";import{Bt as n,Ft as r,Gt as i,Mt as a,gn as o,vn as s}from"./FloatArray-BPbliE26-QHySD8fE.js";function c(c){let l=new e,{vertex:u,fragment:d,varyings:f}=l;return l.fragment.include(s,c),l.include(r),l.include(a,c),l.include(n,c),i(u,c),l.attributes.add(`position`,`vec3`),f.add(`vpos`,`vec3`,{invariant:!0}),u.main.add(t`vpos = position;
forwardVertexColor();
