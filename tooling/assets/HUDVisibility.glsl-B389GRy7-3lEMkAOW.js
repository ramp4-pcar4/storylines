import{t as e}from"./glsl-EDZkDhgF-1nQWz_5s.js";import{t}from"./FloatPassUniform-gHcGW-mi-B-N7xlye.js";import{t as n}from"./Texture2DBindUniform-BjIiNL3v-BGoTEUTM.js";import{t as r}from"./FloatBindUniform-avAg5yxD-BhZMNpUZ.js";import{i,n as a,r as o,t as s}from"./View.glsl-YsNDLcX0-C09vZoxz.js";import{n as c,r as l}from"./ScreenSizePerspective.glsl-Dmu3eZ8--CUwBllUI.js";import{n as u}from"./VerticalOffset.glsl-BXr3ZmRy-D1am3O4z.js";import{t as d}from"./BooleanBindUniform-Dh7KRyL2-Dr6FSI4d.js";import{t as f}from"./Float4BindUniform-BljimXR4-BRvmHObd.js";var p=.5;function m(n,d){n.include(c),n.attributes.add(`position`,`vec3`),n.attributes.add(`normal`,`vec3`),n.attributes.add(`centerOffsetAndDistance`,`vec4`);let p=n.vertex;a(p,d),s(p,d),p.uniforms.add(new f(`viewport`,e=>e.camera.fullViewport),new t(`polygonOffset`,e=>e.shaderPolygonOffset),new r(`aboveGround`,e=>e.camera.aboveGround?1:-1)),d.hasVerticalOffset&&u(p),p.code.add(e`struct ProjectHUDAux {
vec3 posModel;
vec3 posView;
vec3 vnormal;
