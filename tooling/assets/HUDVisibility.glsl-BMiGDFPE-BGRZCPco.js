import{t as e}from"./glsl-EDZkDhgF-BXUHa7Co.js";import{t}from"./FloatPassUniform-gHcGW-mi-_VlsNBhT.js";import{t as n}from"./Texture2DBindUniform-BjIiNL3v-BB2Xk7Bq.js";import{t as r}from"./FloatBindUniform-avAg5yxD-BFP92Xuj.js";import{i,n as a,r as o,t as s}from"./View.glsl-DtKDkY_h-DkmvCuEr.js";import{t as c}from"./Float4BindUniform-BljimXR4-BshF8Q3x.js";import{n as l,r as u}from"./ScreenSizePerspective.glsl-Dmu3eZ8--BjGhRx0o.js";import{n as d}from"./VerticalOffset.glsl-CpSd_uMO-By6AzRsO.js";import{t as f}from"./BooleanBindUniform-Dh7KRyL2-B0nmjVjJ.js";var p=.5;function m(n,f){n.include(l),n.attributes.add(`position`,`vec3`),n.attributes.add(`normal`,`vec3`),n.attributes.add(`centerOffsetAndDistance`,`vec4`);let p=n.vertex;a(p,f),s(p,f),p.uniforms.add(new c(`viewport`,e=>e.camera.fullViewport),new t(`polygonOffset`,e=>e.shaderPolygonOffset),new r(`aboveGround`,e=>e.camera.aboveGround?1:-1)),f.hasVerticalOffset&&d(p),p.code.add(e`struct ProjectHUDAux {
vec3 posModel;
vec3 posView;
vec3 vnormal;
