import{S as e}from"./vec2-aaJlEBBD-CCrQ5eBV.js";import{n as t}from"./vec2f64-D8dbcrKD-BWzTcbaA.js";import{t as n}from"./glsl-EDZkDhgF-BXUHa7Co.js";import{t as r}from"./Uniform-Dp2mgLmf-DqxptRHb.js";import{t as i}from"./IntegerPassUniform-EGe6J__S-gy70PlF2.js";import{t as a}from"./HighlightDownsample.glsl-DneLdylV-DaebUQnh.js";var o=class extends r{constructor(e,t){super(e,`ivec2`,1,(n,r,i)=>n.setUniform2iv(e,t(r,i)))}};function s(t){let{vertex:r}=t;r.uniforms.add(new a(`coverageTexture`,e=>e.coverageTexture),new o(`highlightRenderCellCount`,t=>e(c,t.horizontalCellCount,t.verticalCellCount)),new o(`highlightTextureResolution`,({highlightTexture:t})=>e(c,t.descriptor.width,t.descriptor.height)),new i(`highlightLevel`,e=>e.highlightLevel)).constants.add(`cellSize`,`int`,32),t.varyings.add(`sUV`,`vec2`),t.varyings.add(`vOutlinePossible`,`float`),r.code.add(n`const ivec2 cellVertices[4] = ivec2[4](ivec2(0,0), ivec2(1,0), ivec2(0,1), ivec2(1,1));`),r.main.add(n`int cellIndex = gl_InstanceID;
