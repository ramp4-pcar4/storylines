import{t as e}from"./ShaderBuilder-aUMFb5cS-DVyJ2HBP.js";import{n as t,t as n}from"./glsl-EDZkDhgF-1nQWz_5s.js";import{t as r}from"./Float3PassUniform-BEhcqx4m-Cnyd18mw.js";import{t as i}from"./FloatPassUniform-gHcGW-mi-B-N7xlye.js";import{t as a}from"./Texture2DPassUniform-RVTT2Sjh-CON65h7T.js";import{c as o,r as s}from"./Emissions.glsl-C1fRgyHC-DqMZxEPQ.js";import{n as c,t as l}from"./AlphaCutoff-lGKpUdxr-BrWxowLp.js";import{t as u}from"./Float4PassUniform-R_rVPKlL-BwFtLNQV.js";import{a as d,n as f,r as p}from"./VisualVariables.glsl-CLB2wooA-CXYEA8VI.js";import{n as m,t as h}from"./View.glsl-YsNDLcX0-C09vZoxz.js";import{t as g}from"./TerrainDepthTest.glsl-DZ7tKbZj-52DTmGBr.js";import{t as _}from"./OutputColorHighlightOLID.glsl-vs7-ar26-D5M2ppTl.js";import{r as v}from"./Transform.glsl-B8LYsJdc-Ca2SV5PB.js";import{t as y}from"./VertexColor.glsl-DkZ0DT-i-uQv8JDGl.js";import{a as b}from"./MaterialUtil-Fmbx5pLm-CWcRzx5S.js";import{t as x}from"./MixExternalColor.glsl-67xddAS3-C3Fi8TAM.js";import{r as S}from"./VerticalOffset.glsl-BXr3ZmRy-D1am3O4z.js";import{a as C,d as w,n as T,r as E,t as D}from"./ReadShadowMap.glsl-B3ui5m-b-BEcyRhYh.js";import{c as O,d as k,i as A,l as j,t as ee,u as M}from"./SnowCover.glsl-C23wZ4DV-C15ES6tR.js";import{c as N,i as P,l as F,n as I,r as L,t as R,u as z}from"./DefaultMaterialAuxiliaryPasses.glsl-B2g_FZwE-691jIZS4.js";function B(B){let V=new e,{attributes:H,vertex:U,fragment:W,varyings:G}=V,{output:K,offsetBackfaces:q,pbrMode:J,snowCover:Y,spherical:X}=B,Z=J===1||J===2;if(m(U,B),H.add(`position`,`vec3`),G.add(`vpos`,`vec3`,{invariant:!0}),V.include(d,B),V.include(P,B),V.include(S,B),V.include(g,B),!o(K))return V.include(F,B),V;h(V.vertex,B),V.include(I,B),V.include(v),q&&V.include(z),G.add(`vNormalWorld`,`vec3`),G.add(`localvpos`,`vec3`,{invariant:!0}),V.include(s,B),V.include(N,B),V.include(R,B),V.include(y,B),U.include(p),U.include(f),U.uniforms.add(new u(`externalColor`,e=>e.externalColor,{supportsNaN:!0})),G.add(`vcolorExt`,`vec4`),V.include(B.instancedDoublePrecision?E:T,B),U.main.add(n`
    forwardVertexColor();
