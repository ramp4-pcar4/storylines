import{t as e}from"./ShaderBuilder-qfzG-N7a-DmACrk8a.js";import{t}from"./glsl-EDZkDhgF-BXUHa7Co.js";import{t as n}from"./FloatPassUniform-gHcGW-mi-_VlsNBhT.js";import{t as r}from"./Texture2DPassUniform-RVTT2Sjh-MHqWw8x6.js";import{t as i}from"./HighlightReadBitmap.glsl-O45u9_r0-CeUFZ-o6.js";import{t as a}from"./IntegerPassUniform-EGe6J__S-gy70PlF2.js";import{t as o}from"./Float2DrawUniform-LhTbmE_3-sFZkHKqr.js";import{s,t as c}from"./HighlightDownsample.glsl-DneLdylV-DaebUQnh.js";import{t as l}from"./HighlightCellGridScreenSpacePass.glsl-ssR23D_d-DqU6XsL0.js";function u(){let u=new e;u.include(l);let{fragment:d}=u;return d.uniforms.add(new r(`blurInput`,e=>e.highlightBlurTexture),new o(`blurSize`,e=>e.blurSize),new c(`highlightTexture`,e=>e.highlightTexture),new r(`highlightOptionsTexture`,e=>e.highlightOptionsTexture),new a(`highlightLevel`,e=>e.highlightLevel),new n(`occludedIntensityFactor`,e=>e.occludedFactor)),d.constants.add(`inner`,`float`,1-(9-s)/9),u.include(i),d.main.add(t`vec2 highlightTextureSize = vec2(textureSize(highlightTexture,0));
vec2 uv = sUV;
