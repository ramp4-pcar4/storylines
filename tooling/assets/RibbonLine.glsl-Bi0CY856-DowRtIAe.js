import{n as e}from"./time-CZDdoUVM-CrMH8MxL.js";import{S as t}from"./vec2-aaJlEBBD-CCrQ5eBV.js";import{n}from"./vec2f64-D8dbcrKD-BWzTcbaA.js";import{n as r,t as i}from"./vec4f64-DFGee9an-Ds_BsC0f.js";import{l as a}from"./vec4-DqQz8Ac_-E812nRgt.js";import{t as o}from"./ShaderBuilder-qfzG-N7a-DmACrk8a.js";import{i as s}from"./uuid-KPvt78tX-CcwU7qdY.js";import{n as c,t as l}from"./glsl-EDZkDhgF-BXUHa7Co.js";import{t as u}from"./FloatPassUniform-gHcGW-mi-_VlsNBhT.js";import{t as d}from"./Texture2DPassUniform-RVTT2Sjh-MHqWw8x6.js";import{t as f}from"./Float2BindUniform-DpaMSVXH-D2fHlh4X.js";import{n as p,r as m,t as h}from"./AlphaCutoff-CYKfZXRg-DXKS3VEd.js";import{t as g}from"./ObjectAndLayerIdColor.glsl-C3sEfoJy-iKidzcOy.js";import{t as _}from"./Float4PassUniform-R_rVPKlL-DiM68u5g.js";import{t as v}from"./FloatBindUniform-avAg5yxD-BFP92Xuj.js";import{t as ee}from"./Matrix4BindUniform-gJm9vWnt-BQ342zDj.js";import{n as y,r as b,t as x}from"./View.glsl-DtKDkY_h-DkmvCuEr.js";import{t as S}from"./TerrainDepthTest.glsl-D0F_r5xM-CjVn1995.js";import{t as C}from"./OutputColorHighlightOLID.glsl-DuYrVBF1-BSHMohz0.js";import{t as w}from"./Float4BindUniform-BljimXR4-BshF8Q3x.js";import{t as T}from"./MixExternalColor.glsl-uNucrwe0-C34PV_jx.js";import{t as E}from"./PiUtils.glsl-E150IKCl-C7Hy8C29.js";import{t as D}from"./Float2PassUniform-oNPLRE_S-DVNswLpf.js";import{i as O,o as k,s as A,t as j}from"./MarkerSizing.glsl-Dp78hgvH-CLgIY_zR.js";import{t as M}from"./PositionOutsideClipSpace-I4C860lT-BrKdM2ya.js";var N={dash:[4,3],dot:[1,3],"long-dash":[8,3],"short-dash":[4,1],"short-dot":[1,1]},P={dash:N.dash,"dash-dot":[...N.dash,...N.dot],dot:N.dot,"long-dash":N[`long-dash`],"long-dash-dot":[...N[`long-dash`],...N.dot],"long-dash-dot-dot":[...N[`long-dash`],...N.dot,...N.dot],none:null,"short-dash":N[`short-dash`],"short-dash-dot":[...N[`short-dash`],...N[`short-dot`]],"short-dash-dot-dot":[...N[`short-dash`],...N[`short-dot`],...N[`short-dot`]],"short-dot":N[`short-dot`],solid:null},F=8,I=class{constructor(e,t,n){this.image=e,this.width=t,this.length=n,this.uuid=s()}};function L(e){return e!=null&&`image`in e}function R(e,t){return e==null?e:{pattern:e.slice(),pixelRatio:t}}function z(e){return{pattern:[e,e],pixelRatio:2}}function B(e){switch(e?.type){case`style`:return V(e.style);case`image`:return new I(e.image,e.width,e.length);case void 0:case null:return null}return null}function V(e){return e==null?null:R(P[e],F)}function H(e){return e.pattern.map(t=>Math.round(t*e.pixelRatio))}function U(e){if(e==null)return 1;let t=H(e);return Math.floor(t.reduce((e,t)=>e+t))}function W(e){return e==null?i:e.length===4?e:a(G,e[0],e[1],e[2],1)}var G=r();function K(e,t){if(!t.stippleEnabled)return void e.fragment.code.add(l`float getStippleAlpha(float lineWidth) { return 1.0; }
