import{t as e}from"./ShaderBuilder-qfzG-N7a-DmACrk8a.js";import{n as t,t as n}from"./glsl-EDZkDhgF-BXUHa7Co.js";import{t as r}from"./Float3PassUniform-BEhcqx4m-DR57WjmF.js";import{t as i}from"./FloatPassUniform-gHcGW-mi-_VlsNBhT.js";import{t as a}from"./Texture2DPassUniform-RVTT2Sjh-MHqWw8x6.js";import{c as o,r as s}from"./Emissions.glsl-C1fRgyHC-CGrS4bf2.js";import{n as c,t as l}from"./AlphaCutoff-CYKfZXRg-DXKS3VEd.js";import{t as u}from"./Float4PassUniform-R_rVPKlL-DiM68u5g.js";import{a as d,n as f,r as p}from"./VisualVariables.glsl-DLFsc7-1-BCTRy2of.js";import{n as m,t as h}from"./View.glsl-DtKDkY_h-DkmvCuEr.js";import{t as g}from"./TerrainDepthTest.glsl-D0F_r5xM-CjVn1995.js";import{t as _}from"./OutputColorHighlightOLID.glsl-DuYrVBF1-BSHMohz0.js";import{r as v}from"./Transform.glsl-B8LYsJdc-DQSGKLr8.js";import{t as y}from"./VertexColor.glsl-DkZ0DT-i-Dv7AbXX-.js";import{a as b}from"./MaterialUtil-CTR37o33-D9-rHoNr.js";import{t as x}from"./MixExternalColor.glsl-uNucrwe0-C34PV_jx.js";import{r as S}from"./VerticalOffset.glsl-CpSd_uMO-By6AzRsO.js";import{a as C,d as w,n as T,r as E,t as D}from"./ReadShadowMap.glsl-dCXMBZ4w-C9FPCZwn.js";import{c as O,d as k,i as A,l as j,t as ee,u as M}from"./SnowCover.glsl-wYbF-EO9-Bo8c42ah.js";import{c as N,i as P,l as F,n as I,r as L,t as R,u as z}from"./DefaultMaterialAuxiliaryPasses.glsl-DzmFvfsX-Cd7QLUwP.js";function B(B){let V=new e,{attributes:H,vertex:U,fragment:W,varyings:G}=V,{output:K,offsetBackfaces:q,pbrMode:J,snowCover:Y,spherical:X}=B,Z=J===1||J===2;if(m(U,B),H.add(`position`,`vec3`),G.add(`vpos`,`vec3`,{invariant:!0}),V.include(d,B),V.include(P,B),V.include(S,B),V.include(g,B),!o(K))return V.include(F,B),V;h(V.vertex,B),V.include(I,B),V.include(v),q&&V.include(z),G.add(`vNormalWorld`,`vec3`),G.add(`localvpos`,`vec3`,{invariant:!0}),V.include(s,B),V.include(N,B),V.include(R,B),V.include(y,B),U.include(p),U.include(f),U.uniforms.add(new u(`externalColor`,e=>e.externalColor,{supportsNaN:!0})),G.add(`vcolorExt`,`vec4`),V.include(B.instancedDoublePrecision?E:T,B),U.main.add(n`
    forwardVertexColor();
