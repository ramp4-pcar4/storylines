import{t as e}from"./ShaderBuilder-aUMFb5cS-DVyJ2HBP.js";import{n as t,t as n}from"./glsl-EDZkDhgF-1nQWz_5s.js";import{t as r}from"./Texture2DPassUniform-RVTT2Sjh-CON65h7T.js";import{a as i,r as a,t as o}from"./AlphaCutoff-lGKpUdxr-BrWxowLp.js";import{t as s}from"./Float4PassUniform-R_rVPKlL-BwFtLNQV.js";import{t as c}from"./FloatBindUniform-avAg5yxD-BhZMNpUZ.js";import{t as l}from"./Matrix4BindUniform-gJm9vWnt-B0sBsYyb.js";import{i as u,n as d,r as f}from"./View.glsl-YsNDLcX0-C09vZoxz.js";import{t as p}from"./Float2BindUniform-DpaMSVXH-BGReIXIp.js";import{t as m}from"./TerrainDepthTest.glsl-DZ7tKbZj-52DTmGBr.js";import{t as h}from"./OutputColorHighlightOLID.glsl-vs7-ar26-D5M2ppTl.js";import{t as g}from"./Float4BindUniform-BljimXR4-BRvmHObd.js";import{i as _,o as v,s as y,t as b}from"./MarkerSizing.glsl-D6DTpnXO-sHN_wvGF.js";import{t as x}from"./PositionOutsideClipSpace-I4C860lT-Bdwo5a_h.js";function S(S){let C=new e,{space:w,anchor:T,hasTip:E,hasScreenSizePerspective:D}=S,O=w===2,k=w===1;C.include(y,S),C.include(v,S),C.include(m,S);let{vertex:A,fragment:j,varyings:M}=C;d(A,S),C.attributes.add(`position`,`vec3`),C.attributes.add(`previousDelta`,`vec4`),C.attributes.add(`uv0`,`vec2`),M.add(`vColor`,`vec4`),M.add(`vpos`,`vec3`,{invariant:!0}),M.add(`vUV`,`vec2`),M.add(`vSize`,`float`),E&&M.add(`vLineWidth`,`float`),A.uniforms.add(new p(`nearFar`,({camera:e})=>e.nearFar),new g(`viewport`,({camera:e})=>e.fullViewport)).code.add(n`vec4 projectAndScale(vec4 pos) {
