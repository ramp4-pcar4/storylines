import{t as e}from"./ShaderBuilder-aUMFb5cS-Bh1P788U.js";import{n as t,t as n}from"./glsl-EDZkDhgF-n7nRq5tN.js";import{m as r}from"./Emissions.glsl-C1fRgyHC-BHLvU4yY.js";import{Bt as i,Gt as a,Kt as o,Q as s,Ut as c,Vt as l,Xt as u,Yt as d,bn as f,gn as p,qt as m,vn as h,xn as g}from"./FloatArray-BPbliE26-DBjHebJv.js";import{$ as _,Q as v,at as y,it as b,nt as x}from"./HUDMaterial-wHyCyEzx-vfnKtt10.js";function S(S){let C=new e,{space:w,anchor:T,hasTip:E,hasScreenSizePerspective:D}=S,O=w===2,k=w===1;C.include(y,S),C.include(b,S),C.include(l,S);let{vertex:A,fragment:j,varyings:M}=C;a(A,S),C.attributes.add(`position`,`vec3`),C.attributes.add(`previousDelta`,`vec4`),C.attributes.add(`uv0`,`vec2`),M.add(`vColor`,`vec4`),M.add(`vpos`,`vec3`,{invariant:!0}),M.add(`vUV`,`vec2`),M.add(`vSize`,`float`),E&&M.add(`vLineWidth`,`float`),A.uniforms.add(new c(`nearFar`,({camera:e})=>e.nearFar),new s(`viewport`,({camera:e})=>e.fullViewport)).code.add(n`vec4 projectAndScale(vec4 pos) {
