import{n as e}from"./time-CZDdoUVM-BEj5rBu0.js";import{S as t}from"./vec2-BNGcJ5FZ-dP_UoMdt.js";import{l as n}from"./vec4-DtLpLkJR-CdKCOdK6.js";import{n as r}from"./vec2f64-D8dbcrKD-BS-u17WT.js";import{n as i,t as a}from"./vec4f64-DFGee9an-DomfOCrs.js";import"./enums-BXIvOhb7-BNGbPBKh.js";import"./Texture-SkviwCZk-DmGZudDc.js";import{t as o}from"./ShaderBuilder-aUMFb5cS-DVyJ2HBP.js";import{i as s}from"./uuid-KPvt78tX-aI-65HV9.js";import{n as c,t as l}from"./glsl-EDZkDhgF-1nQWz_5s.js";import{t as u}from"./FloatPassUniform-gHcGW-mi-B-N7xlye.js";import{t as d}from"./Texture2DPassUniform-RVTT2Sjh-CON65h7T.js";import{n as f,r as p,t as m}from"./AlphaCutoff-lGKpUdxr-BrWxowLp.js";import{t as h}from"./ObjectAndLayerIdColor.glsl-C3sEfoJy-DQESEJ0C.js";import{t as g}from"./Float4PassUniform-R_rVPKlL-BwFtLNQV.js";import{t as _}from"./FloatBindUniform-avAg5yxD-BhZMNpUZ.js";import{t as v}from"./Matrix4BindUniform-gJm9vWnt-B0sBsYyb.js";import{n as ee,r as y,t as b}from"./View.glsl-YsNDLcX0-C09vZoxz.js";import{t as x}from"./Float2BindUniform-DpaMSVXH-BGReIXIp.js";import{t as S}from"./TerrainDepthTest.glsl-DZ7tKbZj-52DTmGBr.js";import{t as C}from"./OutputColorHighlightOLID.glsl-vs7-ar26-D5M2ppTl.js";import{t as w}from"./MixExternalColor.glsl-67xddAS3-C3Fi8TAM.js";import{t as T}from"./PiUtils.glsl-E150IKCl-B3zfJNPr.js";import{t as E}from"./Float4BindUniform-BljimXR4-BRvmHObd.js";import{t as D}from"./Float2PassUniform-oNPLRE_S-Cd3_CB19.js";import{i as O,o as k,s as A,t as j}from"./MarkerSizing.glsl-D6DTpnXO-sHN_wvGF.js";import{t as M}from"./PositionOutsideClipSpace-I4C860lT-Bdwo5a_h.js";var N={dash:[4,3],dot:[1,3],"long-dash":[8,3],"short-dash":[4,1],"short-dot":[1,1]},P={dash:N.dash,"dash-dot":[...N.dash,...N.dot],dot:N.dot,"long-dash":N[`long-dash`],"long-dash-dot":[...N[`long-dash`],...N.dot],"long-dash-dot-dot":[...N[`long-dash`],...N.dot,...N.dot],none:null,"short-dash":N[`short-dash`],"short-dash-dot":[...N[`short-dash`],...N[`short-dot`]],"short-dash-dot-dot":[...N[`short-dash`],...N[`short-dot`],...N[`short-dot`]],"short-dot":N[`short-dot`],solid:null},F=8,I=class{constructor(e,t,n){this.image=e,this.width=t,this.length=n,this.uuid=s()}};function L(e){return e!=null&&`image`in e}function R(e,t){return e==null?e:{pattern:e.slice(),pixelRatio:t}}function z(e){return{pattern:[e,e],pixelRatio:2}}function B(e){switch(e?.type){case`style`:return V(e.style);case`image`:return new I(e.image,e.width,e.length);case void 0:case null:return null}return null}function V(e){return e==null?null:R(P[e],F)}function H(e){return e.pattern.map(t=>Math.round(t*e.pixelRatio))}function U(e){if(e==null)return 1;let t=H(e);return Math.floor(t.reduce((e,t)=>e+t))}function W(e){return e==null?a:e.length===4?e:n(G,e[0],e[1],e[2],1)}var G=i();function K(e,t){if(!t.stippleEnabled)return void e.fragment.code.add(l`float getStippleAlpha(float lineWidth) { return 1.0; }
