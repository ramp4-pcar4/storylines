import{o as e}from"./colorUtils-DDC8SjYu-CQvRS7Rn.js";import{n as t,t as n}from"./glsl-EDZkDhgF-n7nRq5tN.js";function r(t){t.constants.add(`GAMMA`,`float`,e).constants.add(`INV_GAMMA`,`float`,1/e).code.add(n`vec3 delinearizeGamma(vec3 color) {
