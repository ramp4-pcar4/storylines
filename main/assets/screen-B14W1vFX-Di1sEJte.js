import{D as e,E as t,F as n,G as r,J as i,N as a,P as o,Q as s,T as c,W as l,dt as u,et as d,f,m as p,pt as m,t as h,ut as g,x as _}from"./vue.esm-bundler-DB3X0LGu-BM1Wi-q2.js";import{t as v}from"./vue-i18n-BPTPk0JE-BgEE4BS4.js";import{V as y,_ as b,c as x,z as S}from"./main-1KUdJJ5H-C22XeP8E.js";import{t as C}from"./marked.esm-BgD7BtT3-BOvoa_Lb.js";g();var w=`<?xml version="1.0" encoding="UTF-8"?>
...
`,O={key:0},k={class:`flex justify-center`},A={key:0,class:`flex flex-col justify-center text-center`},j=[`innerHTML`],M=[`innerHTML`],N={key:3,class:`flex flex-col justify-center text-center`},P={class:`text-xl mt-20`},F={key:1,class:`p-5`},I=c({__name:`screen`,props:{panel:{type:Object,required:!0},payload:{type:Object,required:!0}},setup(c){let g=b(),{t:I}=v(),L=d(`iApi`),R=l(),z=c,B=o(()=>g.status),V=o(()=>g.response),H=l(!1),U=m({}),W=m([]),G=m([]);a(()=>{g.status=`loading`,K(),W.push(L.event.on(x.LAYER_REMOVE,e=>{z.payload.layer?.uid===e.uid&&z.panel.close()})),G.push(u(()=>z.payload.layer.uid,(e,t)=>{e!==t&&(g.status=`loading`,K())}))}),n(()=>{W.forEach(e=>L.event.off(e)),G.forEach(e=>e())});let K=async()=>{if(H.value=z.payload.layer!==void 0&&!z.payload.layer.isRemoved,H.value){if(z.payload.type===`xml`){let e=await q(z.payload.url,[]);if(g.status=`success`,e?.firstElementChild){let t=document.createElement(`div`);t.appendChild(X(`${e.firstElementChild.outerHTML}`)),(z.payload.catalogueUrl||z.payload.url)&&t.appendChild(X(`<h5 class="text-xl font-bold mb-3">${I(`metadata.xslt.metadata`)}</h5>`)),z.payload.catalogueUrl&&t.appendChild(X(`<p><a style="color: blue;" href="${z.payload.catalogueUrl}" target="_blank">${I(`metadata.xslt.cataloguePage`)}</a></p>`)),t.appendChild(X(`<p><a style="color: blue;" href="${z.payload.url}" target="_blank">${I(`metadata.xslt.metadataPage`)}</a> (xml)</p>`)),g.response=t.outerHTML}}else if(z.payload.type===`html`){let e=await Y(z.payload.url);g.status=e.status,g.response=e.response}else if(z.payload.type===`md`){let e=await Y(z.payload.url);g.status=e.status,g.response=C(e.response,{async:!1})}}},q=async(e,t)=>{let n;if(n=z.payload.xmlType&&z.payload.xmlType===`DCAT`?L.language===`en`?E:D:L.language===`en`?w:T,n=n.replace(/\{\{([\w.]+)\}\}/g,(e,t)=>I(t)),!U[e]){let t=await Y(e);if(t.status===`error`){let e=t.reason?I(`metadata.notification.rawFallbackWithReason`,{reason:t.reason}):I(`metadata.notification.rawFallback`);L.notify.show(y.WARNING,e)}U[e]=t.response}return J(U[e],n,t)},J=(e,t,n)=>{let r=null;if(window.XSLTProcessor){let i=new window.XSLTProcessor,a=new DOMParser,o=a.parseFromString(e,`text/xml`),s=a.parseFromString(t,`text/xml`);i.importStylesheet(s),n&&n.forEach(e=>i.setParameter(``,e.key,e.value||``)),r=i.transformToFragment(o,document);let c={className:`underline text-blue-700 break-all`,target:`_blank`,validate:{url:e=>/^https?:\/\//.test(e)}},l=r.firstElementChild;l&&(z.payload.treatXmlAsMarkdown?l.innerHTML=C.parse(l.innerHTML,{async:!1}):l.innerHTML=S(l.innerHTML,c))}return r},Y=e=>new Promise(t=>{let n=new XMLHttpRequest;n.open(`GET`,e,!0),n.responseType=`text`,n.onload=()=>{n.status===200?t({status:`success`,response:n.response}):t({status:`error`,response:`Could not load results from remote service.`,reason:(n.statusText?`${n.status} ${n.statusText}`:`HTTP ${n.status}`)||void 0})},n.onerror=()=>{t({status:`error`,response:`Could not load results from remote service.`})},n.send()});function X(e){let t=document.createElement(`div`);return t.innerHTML=e,t}return(n,a)=>{let o=s(`panel-screen`);return e(),h(o,{panel:c.panel,ref_key:`el`,ref:R},{header:i(()=>[t(f(p(I)(`metadata.title`))+`: `+f(c.payload.layerName),1)]),content:i(()=>[H.value?(e(),r(`div`,O,[_(`div`,k,[B.value==`loading`?(e(),r(`div`,A,f(p(I)(`metadata.loading`)),1)):c.payload.type===`xml`&&B.value==`success`?(e(),r(`div`,{key:1,innerHTML:V.value,class:`flex flex-col justify-center max-w-full xml-content`},null,8,j)):(c.payload.type===`html`||c.payload.type===`md`)&&B.value==`success`?(e(),r(`div`,{key:2,innerHTML:V.value,class:`flex flex-col justify-center max-w-full metadata-view`},null,8,M)):(e(),r(`div`,N,[a[0]||=_(`img`,{src:`https://i.imgur.com/fA5EqV6.png`},null,-1),_(`span`,P,f(p(I)(`metadata.error`)),1)]))])])):(e(),r(`div`,F,[_(`span`,null,f(p(I)(`metadata.label.no.layer`)),1)]))]),_:1},8,[`panel`])}}});export{I as default};